                ...
                <div class="page-inner">
                    ...
                    <div class="row">
                        ...
                        <ul class="breadcrumbs mb-3">
                            ...
                            <li class="nav-item">
                                <a href="index.php?page=managerCompany">Quản lý danh mục cấp 3</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="container mt-4">
                            <h3 class="mb-4">Quản lý danh mục cấp 3</h3>
                            <a href="index.php?page=managerCategoryItem&category_id=<?php echo $categoryId; ?>" class="btn btn-secondary mx-2"><i class="icon-arrow-left"></i>&nbsp; Quay lại</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="addCompanytModalLabel">Thêm thương hiệu</h5>
                                        ...
                                        <div class="modal-body">
                                            <form
                                                ...
                                                <div class="mb-3">
                                                    <label for="category_name" class="form-label">Tên thương hiệu: <span class="text-danger"> * </span></label>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form
                                                        ...
                                                        method="POST" enctype="multipart/form-data">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="editCompanyModalLabel">Sửa tên thương hiệu</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label for="category_name">Tên thương hiệu<span class="text-danger"> * </span></label>
