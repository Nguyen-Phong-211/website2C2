<script>
    ...
    //         .then((data) => {
    //             if (data.success) {
    //                 // Change the notification's status visually after the update
    //                 document.querySelector(`#notification-${notificationId}`).classList.add('text-muted'); // or change to a different class based on status
