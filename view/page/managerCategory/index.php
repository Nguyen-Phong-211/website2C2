                ...
                <div class="page-inner">
                    ...
                    <div class="row">
                        ...
                        <ul class="breadcrumbs mb-3">
                            ...
                            <li class="nav-item">
                                <a href="index.php?page=managerCategory">Quản lý danh mục cấp 1</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="container mt-4">
                            <h3 class="mb-4">QUẢN LÝ DANH MỤC CẤP 1</h3>
                            <a href="index.php?page=home" class="btn btn-secondary mx-2">Quay lại</a>
                            ...
                            <table class="table table-bordered mt-4">
                                <thead>
                                    <tr>
                                        ...
                                        <strong>
                                            <th style="padding-left: 40px;">Quản lý</th>
                                        </strong>
                                    </tr>
                                </thead>
                                <tbody>
