        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-check">
                        <input class="form-check-input border-color" type="radio" name="flexRadioDefault" id="flexRadioDefault3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input border-color" type="radio" name="flexRadioDefault" id="flexRadioDefault2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input border-color" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                    ...
                    <div class="form-check">
                        <input class="form-check-input border-color"  type="radio" name="flexRadioDefault" id="flexRadioDefault">
            ...
            <div class="col-md-12">
                <form action method="post">
                    ...
                    <button type="button" value
                        class="btn btn-primary w-100">Xoá tất
                        cả</button>
