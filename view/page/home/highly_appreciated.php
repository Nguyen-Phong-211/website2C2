        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="swiper">
                    ...
                    $productHightlyApps = $productController->getProductHightlyAppreciatedController();

                    foreach ($productHightlyApps as $productHightlyApp) {
                        echo '
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.php?page=detailProduct&idp='.$productHightlyApp['product_id'] .'" title="'. $productHightlyApp['product_name'] .'">
                                    <img src="asset/image/product/'. $productHightlyApp['image_name'] .'" alt="'. $productHightlyApp['image_name'] .'" class="tab-image img-fluid">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                            <a class="fs-6 fw-normal text-truncate text-decoration-none" href="index.php?page=detailProduct&idp='. $productHightlyApp['product_id'] .'">'. $productHightlyApp['product_name'] .'</a>
                                <div>
                                    <span class="rating">';
                                    if($productHightlyApp['rating_star'] >= 4.6 && $productHightlyApp['rating_star'] <= 5){
                                        echo '
                                    ...
                                    elseif($productHightlyApp['rating_star'] == 4.5){
                                        echo '
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                            </svg>
                        ...
                        echo '      </span>
                                    <small>
                                        '. rand(54, 102) .' lượt đánh giá
                                    </small>
                                </div>
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    <span class="text-dark fw-semibold">
                                        '. number_format($productHightlyApp['price'], 0, ',', '.') .' đồng
                                    </span>
                                    <span class="badge rounded fw-bold px-1 fs-7 lh-1 bg-warning text-black ms-2">';
                                    if($productHightlyApp['discount'] != 0){
                                        echo $productHightlyApp['discount'] * 100 .'% OFF';
                                    }else{
                                    ...
                                    <div class="row g-1 mt-2">
                                        <div class="col-9">
                                            <a href="javascript:void(0);" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart" 
                                                    onclick="addToCart('. $productHightlyApp['product_id'] .')">
                                        ...
                                        <div class="col-3">';
                                        if($productHightlyApp['wstatus'] === NULL){
                                            echo '
                                            <form action="index.php?page=whistlist" method="post">
                                                <input type="hidden" name="productId" value="' . $productHightlyApp['product_id'] . '"> 
                                            ...
                                            <form action="" method="post">
                                                <input type="hidden" name="whistlistId" value="'. $productHightlyApp['whistlist_id'] .'">
