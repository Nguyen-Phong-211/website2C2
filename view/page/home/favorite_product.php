                    ...
                    <?php 
                        ...
                        foreach($dataFavorites as $dataFavorite){
                            ...
                            <div class="product-item swiper-slide">
                                <figure>
                                    <a href="index.php?page=detailProduct&idp='. $dataFavorite['product_id'] .'" title="'.$dataFavorite['product_name'] .'">
                                        <img src="asset/image/product/'. $dataFavorite['image_name'] .'" alt="Product Thumbnail" class="tab-image">
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                                <a class="fs-6 fw-normal text-truncate text-decoration-none" href="index.php?page=detailProduct&idp='. $dataFavorite['product_id'] .'">'. $dataFavorite['product_name'] .'</a>
                                    <div>
                                        <span class="rating">';
                                        if($dataFavorite['rating_star'] >= 4.6 && $dataFavorite['rating_star'] <= 5){
                                            echo '
                                        ...
                                        elseif($dataFavorite['rating_star'] == 4.5){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] >= 4 && $dataFavorite['rating_star'] <= 4.4){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] >= 3.5 && $dataFavorite['rating_star'] <= 3.9){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] == 3){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] >= 2.5 && $dataFavorite['rating_star'] <= 2.9){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] == 2){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] >= 1.5 && $dataFavorite['rating_star'] <= 1.9){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        elseif($dataFavorite['rating_star'] == 1){
                                            echo '
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#ffd700" class="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                                </svg>
                                        ...
                                        <div class="row g-1 mt-2">
                                            <div class="col-9">
                                                <a href="javascript:void(0);" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart" 
                                                    onclick="addToCart('. $dataFavorite['product_id'] .')">
                                            ...
                                            <div class="col-3">';
                                            if($dataFavorite['wstatus'] === NULL){
                                                echo '
                                                <form action="index.php?page=whistlist" method="post">
                                                    <input type="hidden" name="productId" value="' . $dataFavorite['product_id'] . '"> 
                                                ...
                                                <form action="" method="post">
                                                    <input type="hidden" name="whistlistId" value="'. $dataFavorite['whistlist_id'] .'">
